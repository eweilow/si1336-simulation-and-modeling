...
points, relaxations, accuracy, data = loadFile("./data/1026_exact_1_2.bin")
plotData("./plots/1026/a_exact_1_2.png", points, relaxations,
         accuracy, data, linearDimension=dimension, realTitle="Exact (150000 relaxations)", postfix=False)

points, relaxations, accuracy, data = loadFile("./data/1026_baseline_1_2.bin")
plotData("./plots/1026/a_baseline_1_2.png", points, relaxations,
         accuracy, data, linearDimension=dimension, realTitle="No multigrid")

points, relaxations, accuracy, data = loadFile(
    "./data/1026_premultigrid_1_2.bin")
plotData("./plots/1026/a_premultigrid_1_2.png", points, relaxations,
         accuracy, data, linearDimension=dimension, realTitle="Directly after multigrid")

points, relaxations, accuracy, data = loadFile("./data/1026_multigrid_1_2.bin")
plotData("./plots/1026/a_multigrid_1_2.png", points, relaxations,
         accuracy, data, linearDimension=dimension, realTitle="With multigrid")

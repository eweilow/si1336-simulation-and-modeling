...
Using Velocity Verlet: Pendulum has slightly longer period.

---

## 1.1 - Pendulums: general solution

![](./plots/1_1/sol_pendulum_1.png)
![](./plots/1_1/sol_pendulum_2.png)
![](./plots/1_1/sol_pendulum_3.png)

Using Velocity Verlet: Energy doesn't scale linearly with increased starting angle.
...
Using Velocity Verlet: Basically the same solutions as for pendulums. 
...
Using Velocity Verlet: sees a drift in period, but the numerical integration is stable.
